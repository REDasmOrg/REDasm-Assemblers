...
ARMThumbAssembler::ARMThumbAssembler(): ARMCommonAssembler() { }
size_t ARMThumbAssembler::bits() const { return 16; }

u64 ARMThumbAssembler::pc(const Instruction *instruction) const
{
    /*
...
void ARMThumbAssembler::init(const AssemblerRequest &req) { this->open(CS_MODE_ARM, CS_MODE_THUMB); }
