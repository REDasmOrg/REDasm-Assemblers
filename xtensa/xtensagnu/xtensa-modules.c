...
static void
Implicit_Field_set (xtensa_insnbuf insn,
            uint32 val)
{
  /* Do nothing.  */
}
...
static unsigned
Implicit_Field_ar0_get (const xtensa_insnbuf insn)
{
  return 0;
}

static unsigned
Implicit_Field_ar4_get (const xtensa_insnbuf insn)
{
  return 4;
}

static unsigned
Implicit_Field_ar8_get (const xtensa_insnbuf insn)
{
  return 8;
}

static unsigned
Implicit_Field_ar12_get (const xtensa_insnbuf insn)
{
  return 12;
}

static unsigned
Implicit_Field_mr0_get (const xtensa_insnbuf insn)
{
  return 0;
}

static unsigned
Implicit_Field_mr1_get (const xtensa_insnbuf insn)
{
  return 1;
}

static unsigned
Implicit_Field_mr2_get (const xtensa_insnbuf insn)
{
  return 2;
}

static unsigned
Implicit_Field_mr3_get (const xtensa_insnbuf insn)
{
  return 3;
}

static unsigned
Implicit_Field_bt16_get (const xtensa_insnbuf insn)
{
  return 0;
}

static unsigned
Implicit_Field_bs16_get (const xtensa_insnbuf insn)
{
  return 0;
}

static unsigned
Implicit_Field_br16_get (const xtensa_insnbuf insn)
{
  return 0;
}

static unsigned
Implicit_Field_brall_get (const xtensa_insnbuf insn)
{
  return 0;
}
...
static xtensa_funcUnit_internal funcUnits[] = { 0 };
...
static xtensa_interface_internal interfaces[] = { 0 };
...
static int
Operand_arr_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ars_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_art_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ar0_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ar4_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ar8_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ar12_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_ars_entry_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_mr0_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_mr1_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_mr2_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_mr3_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_frr_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_frs_decode (uint32 *valp)
{
  return 0;
}
...
static int
Operand_frt_decode (uint32 *valp)
{
  return 0;
}
