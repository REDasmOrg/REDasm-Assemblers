...
static const char* regname(RDAssemblerPlugin*, const RDInstruction*, const RDOperand*, rd_register_id r) { return ZydisRegisterGetString(static_cast<ZydisRegister>(r)); }
